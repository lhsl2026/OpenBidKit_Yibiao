...
test('real Electron exports persisted synthetic content to a valid Word document without model calls',{timeout:120000},async t=>{
 ...
 // Real Electron cold starts compete with the local Docker stack on this host.
 // Keep this bounded below the production worker's 30-minute ceiling.
 const args={root,electronPath,clientRoot,modelConfig:{provider:'custom',api_key:'offline-only',base_url:'http://127.0.0.1:1/v1',model_name:'no-model-call'},timeoutMs:45000};
