...
const NAMESPACED=Object.freeze({
 ...
 'preread.prepare_upload':{route:'preread_callback',agent:'preread',action:'prepare_upload'},
 'preread.cancel_upload':{route:'preread_callback',agent:'preread',action:'cancel_upload'},
 'preread.select_packages':{route:'preread_callback',agent:'preread',action:'select_packages'},
 'preread.confirm_preprocess_review':{route:'preread_callback',agent:'preread',action:'confirm_preprocess_review'},
 'preread.retry_decomposition_score_review':{route:'preread_callback',agent:'preread',action:'retry_decomposition_score_review'},
 ...
 'company_match.select':{route:'company_match',agent:'openbidkit',action:'select'},
 'company_match.review':{route:'company_match',agent:'openbidkit',action:'review'},
...
function legacyDescriptor(value){
 if(['prepare_upload','cancel_upload','select_packages','confirm_preprocess_review','retry_decomposition_score_review'].includes(value?.action))return {route:'preread_callback',agent:'preread',action:value.action};
